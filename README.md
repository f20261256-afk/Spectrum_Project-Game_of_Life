...
Rules:
    ...
    *How to Run
    *Clone this repo
    *Open Game_of_Life.html in any web browser
...
Controls:
    ...
    *Random — randomly fill the grid
    *Grid size — set a custom grid size, then click Apply
    *Speed slider — control how fast generations advance during Play